...
INSERT INTO "courses" ("slug","title","description","aulas","horas","created")
VALUES
...
-- 1 Selecione todas as aulas do curso de html-para-iniciantes e ordene por lesson_order em ordem crescente. OK
...
SELECT sum("l"."seconds") AS "total_seconds"
FROM "lessons" AS "l"
JOIN "courses" AS "c" ON "l"."course_id" = "c"."id"
WHERE "c"."slug" = 'css-animacoes'
;


-- 3 Contar o total de aulas e agrupar por curso.
SELECT count("l"."title") AS "aulas", "c"."title" AS "curso", *
FROM "lessons" AS "l"
JOIN "courses" AS "c" ON "l"."course_id" = "c"."id"
GROUP BY "c"."title"
;
...
JOIN "courses" AS "c" ON "l"."course_id" = "c"."id"
GROUP BY "c"."title"
HAVING "total_seconds_curso" > 2300
ORDER BY "total_seconds_curso" DESC
;
...
SELECT "c"."id", "u"."name", "u"."email" FROM "certificates" AS "c"
