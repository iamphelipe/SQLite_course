...
('Leo Guima', hex(randomblob(8)), 'leo@email.com', 'leo'),
('Phelipe Pit', hex(randomblob(8)), 'phelipe@email.com', 'phelipe'),
('Guilherme', hex(randomblob(8)), 'guilherme@email.com', 'guilherme'),
('Isadora Guimaraes', hex(randomblob(8)), 'isadora@email.com', 'isadora'),
('Renato Abreu', hex(randomblob(8)), 'renato@email.com', 'renato'),
('Livia Karem', hex(randomblob(8)), 'livia@email.com', 'livia'),
('Yuri Gomes', hex(randomblob(8)), 'yuri@email.com', 'yuri'),
('Dudu', hex(randomblob(8)), 'dudu@email.com', 'dudu'),
('Dina Guimaraes', hex(randomblob(8)), 'dina@email.com', 'dina');
...
INSERT INTO "sessions" ("token", "user_id", "ip", "expires")
VALUES
